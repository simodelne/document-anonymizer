...
import { runStage as runExportDocument } from './stages/export_document.js';
...
export const handlers: Record<string, ToolHandler> = {
  ...
  async complete_export_document(payload) {
    const output = await runExportDocument(
      resolveStageInput(payload as HandlerPayload, 'export_document'),
      createStageRuntime(payload as HandlerPayload),
    );
    return normalizeStageOutput(output, 'export_document', 'pure-compute', undefined);
  },
